...
#part B
search = input("Please enter two search strings: ")
...
for i, quote in enumerate(data_list):
    ...
    if ((found_at1 >= 0) or (found_at2 >= 0)):
        if (found_at1 >= 0):
            print("Found at ", i, "..." + quote[found_at1:found_at1 + 50], "...")

        elif (found_at2 >= 0):
            if (found_at1 == found_at2):
                continue
            print("Found at ", i, "..." + quote[found_at2:found_at2 + 50], "...")
    else:
        count=count+1
