...
#part e
search = input("Please enter two search strings: ") #part B
...
count = 0
count1 = 0
oper = input("Enter AND or OR operation u want to perform: ")
if(qu1==qu2):
    print("u are not allowed to search for two similar keywords.")
else:
    for i, quote in enumerate(data_list):
        found_at1 = quote.find(qu1)
        found_at2 = quote.find(qu2)
        if (oper.lower() == "and"):
            if ((found_at1 >= 0) and (found_at2 >= 0)):
                print("Found:", i, "..." + quote[found_at1:found_at1 + 50], "...")

                count = count + 1

        else:
            if (found_at1 >= 0):
                print("Found:" "..." + quote[found_at1:found_at1 + 50], "...")

            if (found_at2 >= 0):
                if (found_at1 == found_at2):
                    continue
                    print("Found:" "..." + quote[found_at2:found_at2 + 50], "...")
                    count1 = count1 + 1
